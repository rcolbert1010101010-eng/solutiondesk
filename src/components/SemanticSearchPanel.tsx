    ...
    <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-lg pl-9 pr-9 py-2 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400/30"
              />
              {internalQuery && (
                <button
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-amber-400 hover:bg-amber-500 text-white text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              Search
            </button>
          </div>
      ...
      {!loading && searched && results.length === 0 && (
        <div className="text-center py-6 text-slate-400 text-sm">
          <Lightbulb size={20} className="mx-auto mb-2 text-slate-300" />
